            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control percent" name="per_water" id="per_water" required>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control percent" name="per_alcohol" id="per_alcohol" required>
                            <div class="input-group-append">
                                <div class="input-group-text">%</div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control percent" name="per_fragrance" id="per_fragrance" required>
                            <div class="input-group-append">
                                <div class="input-group-text">%</div>
                            </div>
                        </div>
